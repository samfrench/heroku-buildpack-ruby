...
WARNING
        ...
        Dir.mktmpdir("libyaml-") do |tmpdir|
          ...
          FileUtils.cp(File.expand_path(File.join(File.dirname(__FILE__), "../../tmps/Gemfile")), "#{pwd}/")
          FileUtils.cp(File.expand_path(File.join(File.dirname(__FILE__), "../../tmps/Gemfile.lock")), "#{pwd}/")
